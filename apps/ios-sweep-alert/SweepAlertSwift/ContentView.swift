...
struct SharedCarCrew {
    ...
    static let demo = SharedCarCrew(
        ...
        cars: [
            CrewCar(id: "roommates-honda", name: "Roommates' Honda", tint: SweepColors.blue, colorName: "blue", activeSession: nil),
            CrewCar(id: "maya-subaru", name: "Maya's Subaru", tint: Color.green, colorName: "green", activeSession: nil)
        ],
        members: [
            CrewMember(id: "landseer", name: "Landseer", role: "Owner", tint: SweepColors.blue, isCurrentUser: true),
...
struct ContentView: View {
    ...
    private var header: some View {
        HStack {
            Text("SweepAlert")
                ...
                .overlay {
                    Capsule()
                        .stroke(SweepColors.cardStroke, lineWidth: 1)
                }
    ...
    private var parkHereButton: some View {
        Button {
            ...
            Label("Park Here", systemImage: "mappin.circle.fill")
                ...
                .padding(.vertical, 14)
                .background(SweepColors.blue)
                .clipShape(Capsule())
                .shadow(color: SweepColors.blue.opacity(0.30), radius: 14, x: 0, y: 8)
        }
    ...
    private func sharedCarCrew(from remoteCrew: RemoteCrewSnapshot) -> SharedCarCrew {
        let palette: [Color] = [SweepColors.blue, Color.green, Color.orange, Color.purple, Color.teal]
...
struct RulesSheet: View {
    ...
    private var loadingContent: some View {
        VStack(spacing: 14) {
            ZStack {
                Circle()
                    .fill(SweepColors.blue.opacity(0.12))
                    .frame(width: 54, height: 54)

                ProgressView()
                    .progressViewStyle(.circular)
                    .tint(SweepColors.blue)
            }
                ...
                HStack(spacing: 8) {
                    ForEach(cars) { car in
                        ...
                        Button {
                            ...
                            .foregroundStyle(isSelected ? .white : SweepColors.ink)
        ...
        VStack(alignment: .leading, spacing: 12) {
            HStack(alignment: .center, spacing: 10) {
                Image(systemName: "person.2.fill")
                    ...
                    .foregroundStyle(SweepColors.blue)
                    .frame(width: 30, height: 30)
                    .background(SweepColors.blue.opacity(0.10))
                    .clipShape(Circle())
            ...
            if isReparking {
                ...
                Button(action: onClaimMove) {
                    Label(lastMoveActivity == nil ? "I'll move it" : "Move \(selectedCar?.name ?? "car") again", systemImage: "figure.walk")
                        ...
                        .shadow(color: SweepColors.blue.opacity(0.18), radius: 10, x: 0, y: 5)
                }
                .padding(.horizontal, 20)
                .padding(.top, 16)
    ...
    private var reparkActions: some View {
        ...
        .padding(12)
        .background(SweepColors.blue.opacity(0.08))
        .clipShape(RoundedRectangle(cornerRadius: 18, style: .continuous))
        .padding(.horizontal, 16)
        .padding(.top, 12)
    }
                    ...
                    ForEach(sides, id: \.self) { side in
                        ...
                        Button {
                            ...
                            Text(formatSide(side))
                                ...
                                .padding(.vertical, 9)
                                .background(isSelected ? SweepColors.blue : Color(.systemBackground).opacity(0.82))
                                .clipShape(Capsule())
                                .overlay {
                                    Capsule()
                                        .stroke(isSelected ? SweepColors.blue : Color(.separator).opacity(0.4), lineWidth: 0.75)
                                }
                        }
                        .buttonStyle(.plain)
                    }
        ...
        VStack(alignment: .leading, spacing: 14) {
            HStack(alignment: .center, spacing: 12) {
                Image(systemName: "person.2.badge.key.fill")
                    ...
                    .background(SweepColors.blue.opacity(0.12))
                    .clipShape(Circle())
...
struct CarMapMarker: View {
    ...
    var body: some View {
        VStack(spacing: 4) {
            ...
            .overlay {
                Circle()
                    .stroke(isSelected ? SweepColors.ink.opacity(0.18) : Color.clear, lineWidth: 3)
            }
            ...
            VStack(alignment: .leading, spacing: 8) {
                HStack(spacing: 8) {
                    Image(systemName: "road.lanes")
                        ...
                        .background(SweepColors.blue.opacity(0.11))
                        .clipShape(Circle())
        ...
        settingsGroup(title: "Account") {
            HStack(spacing: 12) {
                Image(systemName: authentication.isAuthenticated ? "checkmark.seal.fill" : "person.crop.circle.badge.plus")
                    .font(.system(size: 18, weight: .bold))
                    .foregroundStyle(authentication.isAuthenticated ? Color.green : SweepColors.blue)
                    .frame(width: 34, height: 34)
                    .background((authentication.isAuthenticated ? Color.green : SweepColors.blue).opacity(0.10))
                    .clipShape(Circle())
                ...
                if authentication.isLoading {
                    ...
                    Button {
                        ...
                        Text(authentication.isAuthenticated ? "Log out" : "Log in")
                            ...
                            .padding(.vertical, 8)
                            .background(authentication.isAuthenticated ? Color(.secondarySystemBackground) : SweepColors.blue)
                            .clipShape(Capsule())
                    }
    ...
    private func reminderButton(hours: Double) -> some View {
        ...
        return Button {
            ...
            Text(formatReminderLeadTime(hours))
                ...
                .frame(maxWidth: .infinity)
                .padding(.vertical, 9)
                .background(selected ? SweepColors.blue : Color(.secondarySystemBackground))
            .clipShape(RoundedRectangle(cornerRadius: 12, style: .continuous))
        }
    }
